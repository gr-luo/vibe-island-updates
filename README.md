...
- 🔔 **实时状态** - 在 Notch 区域显示 Claude Code 运行状态
- ✅ **权限审批** - 直接在面板中批准/拒绝权限请求
- 💬 **问答交互** - AskUserQuestion 可直接点击选项回答
- 🎯 **精确跳转** - 点击通知直接回到正确的终端窗口
- 🔄 **自动更新** - 内置 Sparkle，新版本自动推送

## 📥 安装

1. **下载** - 点击上方蓝色按钮下载 DMG
2. **安装** - 打开 DMG，将 Vibe Island 拖到 Applications
3. **启动** - 首次启动会自动配置 Claude Code hooks

## 🖥️ 支持的终端

iTerm2 • Warp • Ghostty • VS Code • Terminal • Cursor • Alacritty • Kitty • Hyper • Zed
